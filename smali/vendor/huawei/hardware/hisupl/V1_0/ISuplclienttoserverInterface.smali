...
.method public static asInterface(Landroid/os/IHwBinder;)Lvendor/huawei/hardware/hisupl/V1_0/ISuplclienttoserverInterface;
    ...
    instance-of v2, v1, Lvendor/huawei/hardware/hisupl/V1_0/ISuplclienttoserverInterface;
    ...
    check-cast v0, Lvendor/huawei/hardware/hisupl/V1_0/ISuplclienttoserverInterface;

    return-object v0

    .line 18
    :cond_1
    new-instance v2, Lvendor/huawei/hardware/hisupl/V1_0/ISuplclienttoserverInterface$Proxy;

    invoke-direct {v2, p0}, Lvendor/huawei/hardware/hisupl/V1_0/ISuplclienttoserverInterface$Proxy;-><init>(Landroid/os/IHwBinder;)V

    .line 21
    .local v2, "proxy":Lvendor/huawei/hardware/hisupl/V1_0/ISuplclienttoserverInterface;
    :try_start_0
    invoke-interface {v2}, Lvendor/huawei/hardware/hisupl/V1_0/ISuplclienttoserverInterface;->interfaceChain()Ljava/util/ArrayList;
    ...
    const-string v5, "vendor.huawei.hardware.hisupl@1.0::ISuplclienttoserverInterface"
...
.method public static getService()Lvendor/huawei/hardware/hisupl/V1_0/ISuplclienttoserverInterface;
    ...
    invoke-static {v0}, Lvendor/huawei/hardware/hisupl/V1_0/ISuplclienttoserverInterface;->getService(Ljava/lang/String;)Lvendor/huawei/hardware/hisupl/V1_0/ISuplclienttoserverInterface;
...
.method public static getService(Ljava/lang/String;Z)Lvendor/huawei/hardware/hisupl/V1_0/ISuplclienttoserverInterface;
    .locals 1
    .param p0, "serviceName"    # Ljava/lang/String;
    .param p1, "retry"    # Z
    .annotation system Ldalvik/annotation/Throws;
...
.method public static getService(Z)Lvendor/huawei/hardware/hisupl/V1_0/ISuplclienttoserverInterface;
    .locals 1
    .param p0, "retry"    # Z
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    invoke-static {v0, p0}, Lvendor/huawei/hardware/hisupl/V1_0/ISuplclienttoserverInterface;->getService(Ljava/lang/String;Z)Lvendor/huawei/hardware/hisupl/V1_0/ISuplclienttoserverInterface;
